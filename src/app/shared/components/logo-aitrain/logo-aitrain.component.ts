...
@Component({
  selector: 'app-logo-aitrain',
  standalone: true,
  imports: [],
  template: `
  @if(render === 'header'){
    <svg id="logo-svg" class="w-32 h-auto " viewBox="0 0 3197 787" version="1.1">
      <defs>  
  ...
  @if(render === 'footer'){
    <svg id="logo-svg" class="w-auto h-6" viewBox="0 0 3197 787" version="1.1">
      <defs>  
        <linearGradient id="logo-gradient" x1="50%" y1="0%" x2="50%" y2="100%" > 
            <stop offset="0%" stop-color="#5E17D8">
                <animate attributeName="stop-color" values="#5E17D8; #25CAEB; #5E17D8" dur="3s" repeatCount="indefinite"></animate>
  ...
  `,
  styleUrl: './logo-aitrain.component.scss'
})
export class LogoAitrainComponent {
  @Input() firstColor: string = '#7c3aed'
  @Input() secondColor: string = '#2563eb'
  @Input() render: 'header' | 'footer' = 'header'
}
